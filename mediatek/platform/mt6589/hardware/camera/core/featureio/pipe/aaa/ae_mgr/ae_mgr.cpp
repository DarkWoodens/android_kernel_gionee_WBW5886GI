...
MRESULT AeMgr::UpdateSensorISPParams(AE_STATE_T eNewAEState)
{
    ...
    switch(eNewAEState)
    {
       ...
       //luoxf modify for CR00564339 Begin
        if(g_rAEOutput.rPreviewMode.u4AfeGain > 10111)

        {
            g_rAEOutput.rPreviewMode.i2FlareGain=512;
            g_rAEOutput.rPreviewMode.i2FlareOffset=48;
       }
       //luoxf modify for CR00564339 End
