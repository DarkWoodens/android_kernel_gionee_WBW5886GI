...
#Gionee: zjy 20120424 add for CR00577075 start
if( $ENV{MTK_WEATHER_WIDGET_APP} eq "no" ){
    system("rm out/target/product/$prj/system/app/MtkWeatherWidget.apk") if( -e "out/target/product/$prj/system/app/MtkWeatherWidget.apk");
}
if( $ENV{MTK_WEATHER_PROVIDER_APP} eq "no" ){
    system("rm out/target/product/$prj/system/app/MtkWeatherProvider.apk") if( -e "out/target/product/$prj/system/app/MtkWeatherProvider.apk");
}
#Gionee: zjy 20120424 add for CR00577075 end
