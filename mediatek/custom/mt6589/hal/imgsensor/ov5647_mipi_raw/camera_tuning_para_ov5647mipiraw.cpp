...
{{
    ...
    ISPCcmPoly22:{
        ...
        21641, // i4B_STD
        { // i4P00[9]
            4822500,  -1492500,   -770000,   -917500,   3735000,   -257500,    -20000,  -1895000,		4475000
        },
        { // i4P10[9]
            989674,  -1014201,     24527,    -74529,   -152138,    226667,    -11289,    262156,		-250866
        },
        { // i4P01[9]
            529343,   -590779,     61436,   -230299,   -113800,    344100,    -73694,   -265555,		339249
        },
        { // i4P20[9]
            0,  0,   0,  0,   0,  0, 0,  0,  0
        },
...
const NVRAM_CAMERA_3A_STRUCT CAMERA_3A_NVRAM_DEFAULT_VALUE =
{
    ...
    // AE NVRAM
    {
        ...
        // rCCTConfig
        {
            ...
            1,                 // u4HistStretchStrengthIndex //0
            2,                 // u4AntiOverExpStrengthIndex
            2,                 // u4TimeLPFStrengthIndex
            {1, 3, 5, 7, 8}, // u4LPFConvergeTable[AE_CCT_STRENGTH_NUM]
            90,                // u4InDoorEV = 9.0, 10 base
            -23,               // i4BVOffset delta BV = -2.3
            32,                 // u4PreviewFlareOffset //64
            32,                 // u4CaptureFlareOffset //64
            ...
            15,                // u4FlatnessThres              // 10 base for flatness condition.
            220                 // u4FlatnessStrength
         }
    },
