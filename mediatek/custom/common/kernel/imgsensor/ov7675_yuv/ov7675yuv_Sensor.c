...
static void OV7675_night_mode(kal_bool bEnable)
{
 kal_uint8 temp = OV7675_read_cmos_sensor(0x3B);
   	...
   	SENSORDB("OV7675 night mode ture camera preview_001\r\n");
	...
	{      spin_lock(&ov7675_yuv_drv_lock);
	   ...
	   if(OV7675_Sensor_Driver.MPEG4_encode_mode == KAL_TRUE)
        ...
        OV7675_write_cmos_sensor(0x3B,(temp|0xc0)); 
		}	
	    else 
	   {
	          SENSORDB("OV7675 night mode ture camera preview\r\n");
        ...
        OV7675_write_cmos_sensor(0x92, 0x00);
        OV7675_write_cmos_sensor(0x93, 0x2a);
        OV7675_write_cmos_sensor(0x9d, 0xa5);
        OV7675_write_cmos_sensor(0x9e, 0xa5);
        OV7675_write_cmos_sensor(0xa5, 0x03);
        OV7675_write_cmos_sensor(0xab, 0x03); */ 
	          
        OV7675_Set_Dummy(0,816); 		
        OV7675_write_cmos_sensor(0x3B,(temp&0x1f)); 
        OV7675_write_cmos_sensor(0x2d, 0); 
        OV7675_write_cmos_sensor(0x2e, 0);	       
        OV7675_write_cmos_sensor(0x3B,(temp|0xe0));			  
		  } 		
	}
	else
	{
        ...
        OV7675_Set_Dummy(0,153); 	
        OV7675_write_cmos_sensor(0x3B,(temp&0x1F)); // fixed frame rate
        OV7675_write_cmos_sensor(0x2d, 0); // if not set to zero, maybe AE osillation
        OV7675_write_cmos_sensor(0x2e, 0);
        OV7675_write_cmos_sensor(0x3B,(temp|0xc0));//satuation control 	
...
{                                 
          ...
          OV7675_write_cmos_sensor(0x3a,0x04);//0c
          ...
          OV7675_write_cmos_sensor(0x2a,0x00);
          OV7675_write_cmos_sensor(0x2b,0x00);
          OV7675_write_cmos_sensor(0x92,0x99);
          OV7675_write_cmos_sensor(0x93,0x00);
          
          OV7675_write_cmos_sensor(0x13,0xe0);                 
          OV7675_write_cmos_sensor(0x00,0x00);
          OV7675_write_cmos_sensor(0x10,0x00);  
          
          OV7675_write_cmos_sensor(0xbb,0xa1);  
          OV7675_write_cmos_sensor(0x0d,0x40);//40 60
          OV7675_write_cmos_sensor(0x42,0x00);//00 80
          
          OV7675_write_cmos_sensor(0x14,0x28);
          OV7675_write_cmos_sensor(0xa5,0x07);  
          OV7675_write_cmos_sensor(0xab,0x08);  
          OV7675_write_cmos_sensor(0x24,0x65); 
          OV7675_write_cmos_sensor(0x25,0x33); 
          OV7675_write_cmos_sensor(0x26,0xc2);  
          ...
          //OV7675_write_cmos_sensor(0x1e,0x37);
          ...
          OV7675_write_cmos_sensor(0x7e,0x38);
          OV7675_write_cmos_sensor(0x7f,0x4a);
          OV7675_write_cmos_sensor(0x80,0x5a);
          OV7675_write_cmos_sensor(0x81,0x67);
          OV7675_write_cmos_sensor(0x82,0x71);
          OV7675_write_cmos_sensor(0x83,0x7b);
          OV7675_write_cmos_sensor(0x84,0x85);
          OV7675_write_cmos_sensor(0x85,0x95);
          OV7675_write_cmos_sensor(0x86,0xa4);
          OV7675_write_cmos_sensor(0x87,0xbc);
          OV7675_write_cmos_sensor(0x88,0xd2);
          OV7675_write_cmos_sensor(0x89,0xe5);*/
          
          OV7675_write_cmos_sensor(0x7a,0x15);
          OV7675_write_cmos_sensor(0x7b,0x05);
          OV7675_write_cmos_sensor(0x7c,0x09);
          OV7675_write_cmos_sensor(0x7d,0x10);
          OV7675_write_cmos_sensor(0x7e,0x3a);
          OV7675_write_cmos_sensor(0x7f,0x4c);
          OV7675_write_cmos_sensor(0x80,0x5a);
          OV7675_write_cmos_sensor(0x81,0x68);
          OV7675_write_cmos_sensor(0x82,0x74);
          OV7675_write_cmos_sensor(0x83,0x80);
          OV7675_write_cmos_sensor(0x84,0x8e);
          OV7675_write_cmos_sensor(0x85,0xa4);
          OV7675_write_cmos_sensor(0x86,0xb4);
          OV7675_write_cmos_sensor(0x87,0xc8);
          OV7675_write_cmos_sensor(0x88,0xde);
          OV7675_write_cmos_sensor(0x89,0xf0);   
          
          OV7675_write_cmos_sensor(0x43,0x0a);
          OV7675_write_cmos_sensor(0x44,0xf2);
          OV7675_write_cmos_sensor(0x45,0x34);
          OV7675_write_cmos_sensor(0x46,0x62);
          OV7675_write_cmos_sensor(0x47,0x27);//26
          OV7675_write_cmos_sensor(0x48,0x18);
          OV7675_write_cmos_sensor(0x59,0x88);
          OV7675_write_cmos_sensor(0x5a,0xa8);
          OV7675_write_cmos_sensor(0x5b,0xcd);
          OV7675_write_cmos_sensor(0x5c,0x5e);
          OV7675_write_cmos_sensor(0x5d,0x70);
          OV7675_write_cmos_sensor(0x5e,0x16);
          OV7675_write_cmos_sensor(0x6c,0x0a);
          OV7675_write_cmos_sensor(0x6d,0x55);
          OV7675_write_cmos_sensor(0x6e,0x11);
          OV7675_write_cmos_sensor(0x6f,0x9e);  
            
          OV7675_write_cmos_sensor(0x6a,0x00);
          OV7675_write_cmos_sensor(0x01,0x44);
          OV7675_write_cmos_sensor(0x02,0x56);  
          OV7675_write_cmos_sensor(0x13,0xe7);
  
          OV7675_write_cmos_sensor(0x4f,0x62);
          OV7675_write_cmos_sensor(0x50,0x63);
          OV7675_write_cmos_sensor(0x51,0x01);
          OV7675_write_cmos_sensor(0x52,0x25);
          OV7675_write_cmos_sensor(0x53,0x4f);
          OV7675_write_cmos_sensor(0x54,0x74);
          OV7675_write_cmos_sensor(0x58,0x1a);
          
          OV7675_write_cmos_sensor(0x3f,0x02);
          OV7675_write_cmos_sensor(0x75,0x63);
          OV7675_write_cmos_sensor(0x76,0xe1);
          OV7675_write_cmos_sensor(0x4c,0x00);
          OV7675_write_cmos_sensor(0x77,0x02);
          OV7675_write_cmos_sensor(0x4b,0x09);
          OV7675_write_cmos_sensor(0xc9,0xc0);//60
          OV7675_write_cmos_sensor(0x41,0x38);    
          OV7675_write_cmos_sensor(0x56,0x40);
          
          OV7675_write_cmos_sensor(0x34,0x11);
          OV7675_write_cmos_sensor(0x3b,0x0a);   
          OV7675_write_cmos_sensor(0xa4,0x88);
          OV7675_write_cmos_sensor(0x96,0x00);
	  ...
	  OV7675_write_cmos_sensor(0x1e,0x07);
          ...
          OV7675_write_cmos_sensor(0x1b,0x08);
          ...
          OV7675_write_cmos_sensor(0x09,0x03); //modified Drv Current
          
	   
}
//gionee chenqiang add for switching dual-camera  CR00596333 begin 
void Gionee_OV7675_Init(void) {
	//OV7675_Sensor_Driver_Init_EX();
	...
	OV7675_write_cmos_sensor(0x09, 0x10);//soft power down
	mDELAY(10);
}
//gionee chenqiang add for switching dual-camera CR00596333  end
/*****************************************************************************/
...
//gionee chenqiang add 20120320 for CR00554892 begin
#ifdef GN_MTK_BSP_CAMMERA_HVMIRROR
...
#endif
//gionee chenqiang add 20120320 for CR00554892 end
...

{
	...
	OV7675_Sensor_Driver.dummy_pixels = 0;
	OV7675_Sensor_Driver.dummy_lines = 153;
...
static BOOL OV7675_set_param_effect(UINT16 para)
{
	...
	switch (para)
	{
		...
		case MEFFECT_NEGATIVE:
			OV7675_write_cmos_sensor(0x3A,0x3C);		
			OV7675_write_cmos_sensor(0x67,0x80);		
			OV7675_write_cmos_sensor(0x68,0x80);
			OV7675_write_cmos_sensor(0x56,0x40);
			break;
		...
		case MEFFECT_SEPIABLUE:
			OV7675_write_cmos_sensor(0x3A,0x1C);		
			OV7675_write_cmos_sensor(0x67,0xee);//c0		
			OV7675_write_cmos_sensor(0x68,0x5a);//80
			OV7675_write_cmos_sensor(0x56,0x40);	
			break;
...
static void OV7675_set_banding_for_50Hz(void)
{
	...
	if (OV7675_Sensor_Driver.MPEG4_encode_mode == KAL_TRUE)
   {
	  ...
	  if(KAL_TRUE == OV7675_Sensor_Driver.bNight_mode)
	   {  
		     OV7675_write_cmos_sensor(0xA5, 0x06); //banding step, frame lenth: 1105
		}
	   else
	    {     
		   OV7675_write_cmos_sensor(0xA5, 0x03); //banding step, frame lengh:(510+42)
	    }
	}
   else 
	{
...
{   
	...
	if (OV7675_Sensor_Driver.MPEG4_encode_mode == KAL_TRUE)
	{
	   OV7675_write_cmos_sensor(0x9E,0xa5); //PCLK:26M, Line_lenght:784
	   if(KAL_TRUE == OV7675_Sensor_Driver.bNight_mode)
	   {   		 
	        OV7675_write_cmos_sensor(0xAb, 0x06); //banding step, frame lenth: 1105
	  	}
	   else
	   {	   		 
...
*/
#endif
/*add by chend for CR00397025 end*/
		    break; 
		case FID_AWB_MODE:
...
UINT32 OV7675GetDefaultFramerateByScenario(MSDK_SCENARIO_ID_ENUM scenarioId, MUINT32 *pframeRate) {
...
UINT32 OV7675SetMaxFramerateByScenario(MSDK_SCENARIO_ID_ENUM scenarioId, MUINT32 frameRate) {
	kal_uint32 pclk;
	kal_int16 dummyLine;
	kal_uint16 lineLength,frameHeight;
		
	SENSORDB("OV7675SetMaxFramerateByScenario: scenarioId = %d, frame rate = %d\n",scenarioId,frameRate);
	switch (scenarioId) {
		case MSDK_SCENARIO_ID_CAMERA_PREVIEW:
		case MSDK_SCENARIO_ID_VIDEO_PREVIEW:
		case MSDK_SCENARIO_ID_CAMERA_CAPTURE_JPEG:
		case MSDK_SCENARIO_ID_CAMERA_ZSD:			
			pclk = 26000000;//OV7675_PREVIEW_CLK;
...
/*chend=============================*/
		case SENSOR_FEATURE_SET_MAX_FRAME_RATE_BY_SCENARIO:
			OV7675SetMaxFramerateByScenario((MSDK_SCENARIO_ID_ENUM)*pFeatureData32, *(pFeatureData32+1));
			break;

		case SENSOR_FEATURE_GET_DEFAULT_FRAME_RATE_BY_SCENARIO:
			OV7675GetDefaultFramerateByScenario((MSDK_SCENARIO_ID_ENUM)*pFeatureData32, (MUINT32 *)(*(pFeatureData32+1)));
			break;
/*chend=========end=================*/
