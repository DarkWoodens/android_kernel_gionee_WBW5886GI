...
using namespace NSIspTuning;
 ...
 //luoxiaofei modify for CR00794725 begin   
    UINT32 CurrentPre4R; // R gain
	UINT32 CurrentPre4G; // G gain
	UINT32 CurrentPre4B; // B gain
 //luoxiaofei modify for CR00794725 end  
...
MRESULT AwbMgr::doPvAWB(MINT32 i4FrameCount, MBOOL bAEStable, MINT32 i4SceneLV, MVOID *pAWBStatBuf)
{
 ...
 //luoxiaofei modify for CR00794725 begin   
              CurrentPre4R=g_rAWBOutput.rPreviewAWBGain.i4R;
		CurrentPre4G=g_rAWBOutput.rPreviewAWBGain.i4G;
		CurrentPre4B=g_rAWBOutput.rPreviewAWBGain.i4B;
 //luoxiaofei modify for CR00794725 end  			
...
MRESULT AwbMgr::doCapAWB(MINT32 i4SceneLV, MVOID *pAWBStatBuf)
{
  ...
  //luoxiaofei modify for CR00794725 begin   
	  if(rAWBInput.bIsStrobeFired==MTRUE ||rAWBInput.i4SceneLV >20)
	  	{
	  	MY_LOG("Strobe or LV= %d",rAWBInput.i4SceneLV);
	  m_pIAwbAlgo->handleAWB(rAWBInput, g_rAWBOutput);
         	} 
	  else
	  	{
                 g_rAWBOutput.rCaptureAWBGain.i4R = CurrentPre4R;
                 g_rAWBOutput.rCaptureAWBGain.i4G = CurrentPre4G;
                 g_rAWBOutput.rCaptureAWBGain.i4B = CurrentPre4B;
	       }         	
 //luoxiaofei modify for CR00794725 end  
        // Debug
