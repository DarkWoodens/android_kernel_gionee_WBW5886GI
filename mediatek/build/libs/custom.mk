...
endef
#Gionee lingfen 2012-12-18 add for CR00751846 start
define mtk.custom.generate-macros
$(strip $(foreach t,$(AUTO_ADD_GLOBAL_DEFINE_BY_NAME),$(call .if-cfg-on,$(t),-D$(call uc,$(t))))
$(strip $(foreach t,$(GN_AUTO_ADD_GLOBAL_DEFINE_BY_NAME),$(call .if-cfg-on,$(t),-D$(call uc,$(t))))
$(foreach t,$(AUTO_ADD_GLOBAL_DEFINE_BY_VALUE),$(call .if-cfg-on,$(t),$(foreach v, $(call uc,$($(t))),-D$(v))))
$(foreach t,$(GN_AUTO_ADD_GLOBAL_DEFINE_BY_VALUE),$(call .if-cfg-on,$(t),$(foreach v, $(call uc,$($(t))),-D$(v))))
$(foreach t,$(AUTO_ADD_GLOBAL_DEFINE_BY_NAME_VALUE),$(call .if-cfg-on,$(t),-D$(call uc,$(t))=\"$($(t))\")))
$(foreach t,$(GN_AUTO_ADD_GLOBAL_DEFINE_BY_NAME_VALUE),$(call .if-cfg-on,$(t),-D$(call uc,$(t))=\"$($(t))\")))
endef
#Gionee lingfen 2012-12-18 add for CR00751846 end
